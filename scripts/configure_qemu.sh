...
: "${QEMU_TARGETS_EXCLUDE=alpha-linux-user sparc32plus-linux-user m68k-linux-user sh4-linux-user sh4be-linux-user hppa-linux-user xtensa-linux-user xtensaeb-linux-user microblaze-linux-user microblazeel-linux-user or1k-linux-user hexagon-linux-user cris-linux-user nios2-linux-user}"
